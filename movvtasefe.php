...
$paginador = new Paginador($Id,
        ...
        ROUND(IF(round(rm.pesos - rm.pagoreal,3) = 0,rm.pesos,(rm.pesos - rm.pagoreal)) / rm.precio, 3) volumenR,
        ROUND(IF(round(rm.pesos - rm.pagoreal,3) = 0,rm.pesos,(rm.pesos - rm.pagoreal)),2) pesosR,rm.uuid",
