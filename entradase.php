...
$VenId = utils\IConnection::execSql("SELECT id FROM prv WHERE nombre LIKE '%PEMEX%' AND proveedorde = 'Combustibles';");
?>
<!DOCTYPE html>
<html lang="es" xml:lang="es">
    <head>
        ...
        if ($VcSc["valor"] == 1) {
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    $("#Proveedor").val("<?= $VenId["id"] ?>");
                    $("#Terminal").val("<?= $objectVO->getTerminal() ?>").prop("required", false);
                });
            </script>
            <?php
        }
                            ...
                            <div class="container">
                                ...
                                <div class="row background">                                
                                    <div class="col-12 no-margin">
                                        ...
                                        if ($VcSc["valor"] == 1) {
                                            ?>
                                            <div class="row no-padding" title="Cliente al que se le sera cargado a su estado de cuenta">
                                                <div class="col-5 align-right" style="font-weight: bold;">Cliente :</div>
                                                <div class="col-5">
