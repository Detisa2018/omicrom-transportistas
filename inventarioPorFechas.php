...
$data = array(
    "Nombre" => "Resumen inventario por fecha", "Reporte" => $Id, "Fecha" => $Fecha, "FechaF" => $FechaF,
    "Detallado" => $Detallado, "Desglose" => $Desglose,
    "Turno" => $Turno, "Textos" => "Subtotal", "Filtro" => "1");
$tipo_cliente = array(
    "Credito" => "Credito", "Contado" => "Contado", "Consignacion" => "Consignacion", "Monedero" => "Monederos",
...
$VariablesC = "SELECT valor FROM variables_corporativo  WHERE llave ='VisualizaComprasAditivos'";
$Val = utils\IConnection::execSql($VariablesC);
...
<html lang="es" xml:lang="es">
    <head>
        ...
        <script type="text/javascript" src="js/invPorFechas.js"></script>
        <title><?= $Gcia ?></title>
        <script>
                        ...
                        <tbody>
                            ...
                            foreach ($registros as $rg) {
                                ...
                                if ($Informacion == TipoInformacion::OMICROM || $Informacion == TipoInformacion::COMPARATIVO) {
                                    ...
                                    $InvTeorico = $rg["inventario_teorico"] + ($incluir ? $Rmd["cantidad"] : 0);
                                    ...
                                    ?>
                                    <tr style="<?= $style ?>" title="Fin de muestra: <?= $rg["ffin"] ?> Dif: <?= number_format(($rg["tdif"] / 60), 2) ?> minutos">
