...
$User = "SELECT groupwork FROM authuser WHERE id = " . $usuarioSesion->getId();
$SqlU = utils\IConnection::execSql($User);
?>
                ...
                while ($paginador->next()) {
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            ...
                            if ($SqlU["groupwork"] == 1) {
                                ?>
                                <a href=javascript:winuni("repTicketsDesfasados.php?FechaInfo=<?= $row["fecha_informacion"] ?>&FechaI=<?= $row["fecha_informacion"] ?>")><i class="fa-solid fa-circle-info"></i></a>
                                <?php
                            }
                            ?>
                        </td>
