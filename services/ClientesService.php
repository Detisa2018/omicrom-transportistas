...
if ($request->hasAttribute("Boton") && $request->getAttribute("Boton") !== utils\Messages::OP_NO_OPERATION_VALID) {
    ...
    try {
        ...
        if ($request->hasAttribute("PermisoCRE")) {
            $clienteVO->setObservaciones($request->getAttribute("PermisoCRE"));
        }
        if ($request->hasAttribute("RFCMonedero")) {
            $clienteVO->setObservaciones($request->getAttribute("RFCMonedero"));
        }
        $clienteVO->setUltimaModificacion(date("Y-m-d H:i:s"));
        ...
        $clienteVO->setDescuentocli($sanitize->sanitizeFloat("DescuentoCliente"));
        ...
        if ($Vvl["valor"] == 0 || $Vvl["valor"] == null) {
            $clienteVO->setDescuentocli(0);
        }
