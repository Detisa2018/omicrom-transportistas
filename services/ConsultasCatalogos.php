...
if ($Reporte == 2) {
    ...
    FROM
        ...
        (SELECT 
            ct.id corte,
                ...
                rm.iva,
                rm.precio,
		ROUND(SUM($totaliesp), 2) pesos,
                ROUND(SUM($Iespcorte), 2) volumen
        FROM
            ct
    ...
    $cSql = "SELECT i.id,CONCAT(i.serie ,' - ', i.folio) folio ,'Transporte' detalle,id.importe,id.ieps retencion , i.uuid FROM ingresos_detalle id LEFT JOIN ingresos i ON i.id=id.id WHERE TRUE";
}   