...
if (move_uploaded_file($_FILES["file"]["tmp_name"][0], "/home/omicrom/xml/" . $_FILES["file"]["name"][0])) {
    ...
    foreach ($carga_xml->xpath('//cfdi:Comprobante//cfdi:Conceptos//cfdi:Concepto') as $Concepto) {
        ...
        error_log("Claves de los productos obtenidas: " . $Clave_producto_servicio[$i]);
        $i++;
        #comercializadora
        ...
        if ($VcSc["valor"] == 1 && ($Concepto['ClaveProdServ'] == 15101515 || $Concepto['ClaveProdServ'] == 15101514 || $Concepto['ClaveProdServ'] == 15101505 )) {
            ...
            error_log("Conmsulta a ejecutar:" ." " . $Tcom);
            ...
            $CxcVO->setReferencia($_REQUEST["busca"]);
            ...
            $meTmpVO = new MeVO();
            $meTmpVO = $meTmpDAO->retrieve($_REQUEST["busca"], "carga");
            if ($IdPermiso > 0) {
    ...
    #comprobamos si existe ya el uuid en la tabla me
    ...
    # instanciamos los objetos para el detalle = med
    # me temporal
    # cargas
    ...
    if ($rsMatch || $Clave_producto_servicio[0] == 78101800 || $Clave_producto_servicio[0] == 78101801 || $Clave_producto_servicio[0] == 78101802 || $Clave_producto_servicio[0] == 78101807 || $Clave_producto_servicio[0] == 80141623 || $Clave_producto_servicio[0] == 78141501 || $Clave_producto_servicio[1] == 80141706 || $Clave_producto_servicio[1] == 81141601 || $Clave_producto_servicio[0] == 84111506) {
