        ...
        <table style="width: 100%;" class="texto_tablas" aria-hidden="true">
            <tr>
                <td style="text-align: center; width: 80px;" class="nombre_cliente">
                    <a href="facturas.php"><div class="RegresarCss " alt="Flecha regresar" style="">Regresar</div></a>
                </td>
                <td style="vertical-align: top;">
                    <form name="form1" id="form1" method="post" action="">
                        ...
                        if ($fcVO->getStatus() >= 2) {
                            cInput("Cancelada por:", "Text", "5", "UsrCancelacion", "right", strtoupper($fcVO->getCancelacion()), "5", true, true, "");
                        }
                    ...
                    <table style="width: 100%;padding-right: 15px;padding-left: 15px;" aria-hidden="true">
                        ...
                        if (($clienteVO->getTipodepago() === TiposCliente::CREDITO || $clienteVO->getTipodepago() === TiposCliente::PREPAGO) && $fcVO->getUuid() !== "-----" && $fcVO->getStatus() == StatusFactura::CERRADO) {
                            ...
                            if ($Cxch["var"] == $fcVO->getId()) {
                                ...
                                echo "<a href=javascript:confirmarMov('$self?op=AcentarC&busca=$busca') class='seleccionar' style='font-size:12px;'><strong>Asentar consumos de la factura</strong></a>";
                                echo "</td>";
