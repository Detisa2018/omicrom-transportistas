...
$statusCFDI = array();
if ($Cpo["status"] != 0) {
    $statusCFDI = ConsultaCFDIClient::CallAPI($ciaVO->getRfc(), $clientesVO->getRfc(), $Cpo['cfditotal'], $ObjectVO->getUuid());
}
?>
<!DOCTYPE html>
                        ...
                        <div id="FormulariosBoots">
                            <div class="container no-margin">
                                <div class="row no-padding">
                                    <div class="col-10 background no-margin">
                                        <div class="row no-padding">
                                            <input type="hidden" name="UuidIng" value="<?= $ObjectVO->getUuid() ?>">
                                            <div class="col-4 align-right">Correo: </div>
                                            <div class="col-5"><input type="text" name="Correo" id="Correo" class="clase-1"/></div>
                                            <div class="col-2 align-right"><input class='nombre_cliente' type='submit' name='Boton' value='Enviar correo' class='texto_tablas'> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
