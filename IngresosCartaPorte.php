...
$CpDAO = new \com\detisa\omicrom\CartaPorteIngresoDAO($busca);
if (is_numeric($busca)) {
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                if ("<?= $ActuNvo ?>" == "Nuevo") {
                    ...
                    $("#DescripcionServicio").val("<?= $IngresosVO->getId_servicios_tra() ?>");
                    ...
                    $("#TerminalAlmacenamiento").val("<?= $IngresosVO->getId_prv() ?>");
                    if ($("#CUnidad").val() === "") {
                        $("#CUnidad").val("LTR");
                    }
                }
            ...
            <tr>
                ...
                <td style="vertical-align: top;">
                    ...
                    if ($IngresosVO->getUuid() === OrigenFacturaIngreso::SINTIMBRAR && $ActuNvo !== "Nuevo") {
                        ?>
                        <div class="facturaCp">  
                            <a aria-hidden="true" data-toggle="modal"  data-target="#modal-de-carga" href="IngresosCartaPortee.php?id=<?= $busca ?>">CONFIRMACIÓN FINAL DE DATOS GENERALES <i class="fa-solid fa-rocket"></i></a>
                        </div>
                        <?php
                    }
                    ?>
                                ...
                                <div class="container no-margin">
                                    <div class="row no-padding">
                                        <div class="col-12 background no-margin">
                                            ...
                                            <div class="row no-padding">  
                                                <div class="col-2 align-right">Terminal de almacenamiento: </div>
                                                <div class="col-6"><?php ComboboxPermisosTerminales::generate("TerminalAlmacenamiento"); ?></div>
                                            </div>
                                            <?php
                                            ...
                                            <div class="row no-padding">  
                                                <?php
                                                $SqlDs = "SELECT id, nombre FROM omicrom.servicios_tra";
                                                $Dsc = utils\IConnection::getRowsFromQuery($SqlDs);
                                                ?>
                                                <div class="col-2 align-right">Descripcion del servicio: </div>
                                                <div class="col-6">
                                                    <select name="DescripcionServicio" id="DescripcionServicio">
                                                        <?php
                                                        foreach ($Dsc as $sc) {
                                                            ?>
                                                            <option value="<?= $sc["id"] ?>"><?= $sc["id"] ?> <?= $sc["nombre"] ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>
                                            ...
                                            <div class="row no-padding">
                                                ...
                                                <div class="col-8 ComprobanteShow " style="padding-top: 5px;">
                                                    <?php CatalogosSelectores::generateClaveCPDis("ClaveCP", "width:60%;"); ?>
                                                </div>
                                            </div>
                                            <div class="row no-padding">
                                                ...
                                                <div class="col-2 ComprobanteShow " style="padding-top: 5px;">
                                                    <input type="text" name="CostoServicio" id="CostoServicio" value="<?= $stArray['preciob'] ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="row no-padding">
                                                <div class="col-2 ComprobanteShow align-right" style="padding-top: 5px;">% de Retencion:</div>
                                                <div class="col-2 ComprobanteShow " style="padding-top: 5px;">
                                                    <input type="number" max="14" min="0" name="RetencionServicio" id="RetencionServicio" value="<?= $stArray["ieps"] > 0 ? $stArray["ieps"] : 0 ?>">
                                                </div>
                                            </div>
                                            <div class="row no-padding">
                                            ...
                                            <div class="row no-padding">
                                                ...
                                                <div class="col-2 VehiculosShow" style="padding-top: 5px;">
                                                    ...
                                                    if ($IngresosVO->getUuid() === OrigenFacturaIngreso::SINTIMBRAR) {
                                                        ?>
                                                        <input type="submit" name="Comprobante" value="<?= $ActuNvo ?>"   class="styleBotonSubmit">
                                                        <?php
                                                    }
                                                    ?>
                                                </div>
                                            ...
                                            <div class="col-12 background no-margin">
                                                <div class="row no-padding">
                                                    ...
                                                    <div class="col-1 DireccionesShow CompleteOrg" style="padding-top: 15px;">
                                                        ...
                                                        if ($IngresosVO->getUuid() === OrigenFacturaIngreso::SINTIMBRAR) {
                                                            ?>
                                                            <input type="submit" name="Remolque" value="Agregar Remolque" id="Remolque"  class="styleBotonSubmit">
                                                            <?php
                                                        }
                                                        ?>
                                                    </div>
                                ...
                                <div class="container no-margin">
                                    <div class="row no-padding"  style="width: 100%;">
                                        <div class="col-12 background no-margin"  style="width: 100%;">
                                            <div id="DireccionesHead" class="col-12" style="font-weight: bold;height: 35px;background-color: #099; padding-top: 10px;padding-left: 40%;font-family: sans-serif; font-size: 15px;color: white;">
                                                Producto para traslado
                                            </div>

                                            <div class="row no-padding">
                                                <div class="col-12 ConceptosShow"></div>
                                            </div>
                                            <form name="DetalleEnvio" id="DetalleEnvio" method="post" action="IngresosCartaPorte.php" title="Mostramos solo direcciónes de proveedores de gasolina">
                                                <div class="row no-padding">
                                                    <div class="col-1 align-right">Producto:</div>
                                                    <div class="col-8 "><?php ComboboxInventario::generate("Producto", "'Combustible'", "") ?></div>
                                                </div>
                                                <div class="row no-padding">
                                                    <div class="col-1 align-right">Cantidad::</div>
                                                    <div class="col-1"><input type="text" id="Cantidad" name="Cantidad" placeholder="Cantidad" required></div>
                                                    <div class="col-2 align-right">Costo por litro:</div>
                                                    <div class="col-1"><input type="text" id="PrecioxLitro" name="PrecioxLitro" placeholder="Costo"></div>
                                                    <div class="col-1">Ó</div>
                                                    <div class="col-1 align-right">Costo total:</div>
                                                    <div class="col-1"><input type="text" id="PrecioTotal" name="PrecioTotal" placeholder="Costo Total"></div>
                                                    <div class="col-1">

                                                        <?php
                                                        if ($IngresosVO->getUuid() === OrigenFacturaIngreso::SINTIMBRAR) {
                                                            ?>
                                                            <input type="submit" name="Boton" value="Agregar Producto" id="ProductoLibre" class="styleBotonSubmit">
                                                ...
                                                <div class="row no-padding">
                                                    <div class="col-12 ConceptosShow">
                                                        <table title="Conceptos de la carta porte" style="background-color: #F2F4F4;width: 80%;margin-left: 10%;margin-top: 20px; border: 1px #566573 solid;border-radius: 10px;">
                                                            ...
                                                            <?php
                                                            $SelectCpds = "SELECT id.idnvo, inv.descripcion,id.cantidad,id.importe,inv.inv_cproducto,inv.inv_cunidad FROM ingresos_detalle id "
                                                            ...
                                                            while ($dt = $Ts->fetch_array()) {
                                                                ...
                                                                <tr  style="background-color: <?= $Fdo ?>">
                                                                    ...
                                                                    if ($IngresosVO->getUuid() === OrigenFacturaIngreso::SINTIMBRAR) {
                                                                        ?>
                                                                        <td style="text-align: center;"><a href="IngresosCartaPorte.php?op=EliminaDetalle&Idnvo=<?= $dt["idnvo"] ?>"><i class="fa-solid fa-trash-can"></i></a></td>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                </tr>
                                            ...
                                            <form name="formCartaPorte5" id="formCartaPorte2" method="post" action="IngresosCartaPorte.php" title="Mostramos solo direcciónes de proveedores de gasolina">
                                                <div class="row no-padding">
                                                    ...
                                                    <div class="col-5 DireccionesShow QuitamosAddOrigen" style="padding-top: 15px;">
                                                        ...
                                                        if ($IngresosVO->getUuid() === OrigenFacturaIngreso::SINTIMBRAR) {
                                                            ?>
                                                            <input type="submit" name="Direcciones" value="<?= $ActuNvo ?>"  class="styleBotonSubmit">
                                                            <?php
                                                        }
                                                        ?>
                                                    </div>
