                    ...
                    <div id="TablaDatos" style="min-height: 80px !important;">
                        ...
                        <form>
                            <table style="border-radius: 20px;" id="ImporteBuscar">
                                <?php
                                $ImpDis = "select SUM(volumen), SUM(importe) importe, COUNT(1) cnt from rm  WHERE corte = $idCorte AND uuid = '-----' AND cliente = 0  AND enviado = 0 AND importe > 0  AND importe = pesos";
                        ...
                        <tr>
                            <td>
                                ...
                                $VentasDelCorte = "SELECT * FROM rm  WHERE corte = $idCorte AND uuid = '-----' AND cliente = 0 AND "
                                        . "importe > 0 AND enviado = 0 AND rm.tipo_venta='D' AND pesos = importe ORDER BY importe DESC";
                                                    ...
                                                    foreach ($RsVdc as $vdc) {
                                                        if ($_SESSION['VentasBorra'][$vdc["id"]] == 0) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: right;"><?= number_format($vdc["importe"] / $vdc["precio"], 2) ?></td>
