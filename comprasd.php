...
<html lang="es" xml:lang="es">
    ...
    $(document).ready(function () {
        ...
        $(".modificarpzs").click(function () {
            const idnvo = $(this).data("idnvo"); 

            Swal.fire({
                title: "Por favor ingresa el número de piezas totales",
                icon: 'warning',
                html: `
                    ¡Para poder ingresar piezas a su inventario y no cajas!<br><br>
                    <input id="numeroPiezas" type="number" class="swal2-input" placeholder="Número de piezas" min="1" required>
                `,
                iconColor: '#C0392B',
                background: "#E9E9E9",
                ...
                preConfirm: () => {
                    ...
                    if (!numeroPiezas || numeroPiezas <= 0) {
                        Swal.showValidationMessage('Por favor ingresa un número válido de piezas');
                        return false;
                    }
                    return numeroPiezas;
                }
                ...
                if (result.isConfirmed) {
                    const numeroPiezas = result.value;
                    ...
                    jQuery.ajax({
                        ...
                        cache: false,
                        data: {
                            Origen: "ComprasDetalle",
                            idnvoCompra: idnvo,
                            numpiezasR: numeroPiezas
                        },
                        beforeSend: function () {
                            Swal.fire({
                                title: 'Cargando',
            ...
            <table class="paginador" aria-hidden="true">
                ...
                while ($paginador->next()) {
                    ...
                    <tr>
                        ...
                        <td class="modificarpzs" style="text-align: right; cursor: pointer;" data-idnvo="<?= $row["idnvo"] ?>" data-cantidad="<?= $row["cantidad"] ?>"><?= $row["cantidad"] ?></td>
