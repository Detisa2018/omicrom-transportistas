...
$BanderaDiferencia = "SELECT valor FROM omicrom.variables_corporativo WHERE llave = 'MuestraDiferencia';";
$Bd = utils\IConnection::execSql($BanderaDiferencia);
        ...
        <div id="container">
                        ...
                        <table style="width: 100%;" aria-hidden="true">
                            ...
                            foreach ($Precios as $rg) {
                                if ($rg["precio"] > 0) {
                                    ...
                                    $PrecioAntes = "SELECT FORMAT(precio , 2) precio FROM omicrom.cp WHERE fechaapli <= "
                                            . "'" . $ctVO->getFecha() . "' AND producto = (SELECT clavei FROM omicrom.com "
                                            . "WHERE descripcion = '" . ucwords(strtolower($rg["descripcion"])) . "') AND "
                                            . "status = 'Ejecutado' order by id desc LIMIT 1;";
                                    $CtA = utils\IConnection::execSql($PrecioAntes);
                                    $Pc = $CtA["precio"];
                                }
                                ?>
                                <tr class="texto_tablas">
                                    <td align="right"><?= ucwords(strtolower($rg["descripcion"])) . ": " ?></td>
                                    <td align="right" style="background-color: #CACACA"><?= "$ " . $Pc ?></td>
                                </tr>
                                <?php
                            }
                            ?>
            ...
            <div id="Reportes" style="min-height: 200px;">
                    ...
                    <table aria-hidden="true">
                        <thead>
                            <tr class="titulo">
                                ...
                                <td colspan="<?= $Bd["valor"] == 1 ? 7 : 6 ?>">Litros</td>
                                <?php
                                if ($MarcaDis) {
                                    ?>
                                    <td colspan="<?= $Bd["valor"] == 1 ? 7 : 6 ?>">Importes</td>
                                    <?php
                                }
                                ?>
                                <td></td>
                            ...
                            <tr>
                                ...
                                if ($Bd["valor"] == 1) {
                                    ?>
                                    <td><a class="ExtraEnvio" href="javascript:window.wingral2('impcorteDiferencias.php?Corte=<?= $Corte ?>')">Diferencia</a></td>
                                    <?php
                                }
                                ?>
                                <td>Venta</td>
                        ...
                        <tbody>
                            ...
                            foreach ($registros as $rg) {
                                if ($Disp <> $rg["$DispAG"]) {
                                    if (!empty($Disp)) {
                                        ...
                                        <tr class="subtotal">
                                            ...
                                            if ($MarcaDis) {
                                                ...
                                                if ($Bd["valor"] == 1) {
                                                    ?>
                                                    <td><?= number_format($TotDiscImpo, 3) ?></td>
                                                    <?php
                                                }
                                                ?>
                                    ...
                                    $Disp = $rg["$DispAG"];
                                    $TotL = $TotI = $JarI = $JarL = $ConsigL = $ConsigI = $TotDiscImpo = $TotDisc = $Descuento = 0;
                                }
                                ?>
                                ...
                                <tr>
                                    ...
                                    $mon = "mon" . $rg["manguera"];
                                    if (number_format($rg["diferenciaDispensario"], 2) > 0) {
                                        $HtmlTxt = "Diferencia positivo";
                                    } elseif (number_format($rg["diferenciaDispensario"], 2) == 0) {
                                        $HtmlTxt = "Dispensarios totalmente calibrados";
                                    } elseif (number_format($rg["diferenciaDispensario"], 2) < 0) {
                                        $HtmlTxt = "Diferencia negativo";
                                    }
                                    ?>
                                    ...
                                    if ($Bd["valor"] == 1) {
                                        ?>
                                        <td class="numero" title="<?= $HtmlTxt ?>"><?= number_format($rg["diferenciaDispensario"], 3) ?></td>
                                        <?php
                                    }
                                    ?>
                                    ...
                                    if ($MarcaDis) {
                                        ...
                                        if ($Bd["valor"] == 1) {
                                            ?>
                                            <td class="numero"><?= number_format($rg["diferenciaDispensarioImp"], 2) ?></td>
                                            <?php
                                        }
                                        ?>
                                ...
                                $TotDisc += $rg["diferenciaDispensario"];
                                $TotDiscImpo += $rg["diferenciaDispensarioImp"];
                                $TotDiscG += $rg["diferenciaDispensario"];
                                $TotDiscImpoG += $rg["diferenciaDispensarioImp"];
                                $JarL += $rg["volumen_j"];
                                $JarI += $rg["pesos_j"];
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                if ($Bd["valor"] == 1) {
                                    ?>
                                    <td><?= number_format($TotDiscG, 3) ?></td>
                                    <?php
                                }
                                ?>
                                ...
                                if ($MarcaDis) {
                                    ...
                                    if ($Bd["valor"] == 1) {
                                        ?>
                                        <td><?= number_format($TotDiscImpoG, 3) ?></td>
                                        <?php
                                    }
                                    ?>
                ...
                <div id="Reportes">
                    <table aria-hidden="true">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>Total</td>
                                <td class="DescuentoT">Descuento</td>
                                <td class="DescuentoT">Desc.M.</td>
                                <td class="DescuentoT"></td>
                                <?php
                                if ($MarcaDis && $Bd["valor"] == 1) {
                                    ?>
                                    <td>Dif</td>
                                    <?php
                                }
                        ...
                        <tbody>
                            ...
                            foreach ($registrosD as $rg) {
                                ...
                                <tr>
                                    ...
                                    <td class="numero DescuentoT DescuentoTxt"><?= number_format($rg["descuento"], 2) ?></td>
                                    <td class="numero DescuentoT DescuentoTxt"><?= number_format($rg["descuentoMon"], 2) ?></td>
                                ...
                                $descuentoMon += $rg["descuentoMon"];
                                $descuentoMonGT += $rg["descuentoMon"];
                                if ($MarcaDis) {
                                    $Diferencia += $dif;
                                }
                                if ($registrosD[$nReg + 1]["isla_pos"] !== $rg["isla_pos"]) {
                                    ...
                                    <tr class="subtotal">
                                        ...
                                        <td  class="DescuentoT DescuentoTxt"><?= number_format($descuento, 2) ?></td>
                                        <td  class="DescuentoT DescuentoTxt"><?= number_format($descuentoMon, 2) ?></td>
                                    ...
                                    <?php
                                    $subVtas = $subLts = $subEfe = $subCre = $subVal = $subTar = $subMon = $subVenta = $subAceE = $subAceC = $subVenta_a = $descuento = $descuentoMon = $Diferencia = 0;
                                }
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td  class="DescuentoT DescuentoTxt"><?= number_format($descuentoMonGT, 2) ?></td>
                    ...
                    <?php
                    if (($nDiferencia > 10 || $nDiferencia < -10) && $TD["marca"] !== "T" && $Bd["valor"] == 1) {
                        ?>
