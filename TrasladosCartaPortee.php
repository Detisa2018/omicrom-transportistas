...
$SqlIngreso = "SELECT t.folio, cia.cia nombre, cia.rfc, cia.codigo, t.usocfdi, t.fecha, cia.clave_regimen regimenfiscal, 
 t.metodopago FROM traslados t 
LEFT JOIN carta_porte cp ON cp.id_origen = t.id 
LEFT JOIN cia ON true
WHERE t.id = $busca AND cp.tabla = 'Traslados'";
        ...
        <table style="width: 100%;" class="texto_tablas" aria-hidden="true">
            <tr>
                <td style="text-align: center;" class="nombre_cliente">
                    <a href="TrasladosCartaPorte.php"><img src="libnvo/regresa.jpg" alt="Flecha regresar"></a><br/>regresar
                </td>
                                ...
                                <div class="col-10 background container no-margin" style="border: 1px solid #007F7F;">
                                    ...
                                    <form name="formulario1" id="formulario1" method="post" action="">
                                        ...
                                        <div class="row no-padding">
                                            ...
                                            <div class="col-3">
                                                <input type="text" name="Nombre" id="Nombre" value="<?= $IngCp["nombre"] ?>" disabled/>
                                            </div>
                                        </div>
                                        <div class="row no-padding">
                                            <div class="col-4 align-right">R.F.C: </div>
                                            <div class="col-3">
                                                <input type="text" name="Rfc" id="Rfc" maxlength="15" value="<?= $IngCp["rfc"] ?>" disabled/>
                                            </div>
                                        </div>
                                        <div class="row no-padding">
                                            <div class="col-4 align-right">Codigo Postal: </div>
                                            <div class="col-1">
                                                <input type="text" name="CodigoPostal" id="CodigoPostal" maxlength="15" disabled/>
                                            </div>
                                        </div>
                                        <div class="row no-padding">
                                            <div class="col-4 align-right">Regimen F: </div>
                                            <div class="col-3">
                                                <select name="RegimenFiscal"  class="texto_tablas" id="RegimenFiscal" disabled>
                                        ...
                                        <div class="row no-padding">
                                            ...
                                            <div class="col-3">
                                                <?= ComboboxUsoCFDI::generateByTypeCli("cuso", strlen($IngCp["rfc"]), "disabled"); ?>
                                            </div>
                                        </div>
                                        <div class="row no-padding">
                                        ...
                                        <div class="row no-padding">
                                            ...
                                            <div class="col-3">
                                                <input type="hidden" name="idTraslado" id="idTraslado" value="<?= $busca ?>">
                                    ...
                                    <form name="form2" id="form2" method="post" action="TrasladosCartaPorte.php?op=Timbra">
                                        <div class="row no-padding">
                                            <div class="col-4 align-right"></div>
                                            <div class="col-4">
