...
$Titulo = "Registro de depositos bancarios del $FechaI al $FechaF";
$Id = 95; /* Número de en el orden de la tabla submenus */
            ...
            <form name="formActions" method="post" action="" id="form" class="oculto">
                <div id="Controles">
                    ...
                    if ($usuarioSesion->getTeam() !== "Operador") {
                        ?>
                        <td style="text-align: center"><a href="report_excel_reports.php?<?= http_build_query($data) ?>"><i title="Descargar archivo Excel" class="icon fa fa-lg fa-file-excel-o" aria-hidden="true"></i></a> 
                    </td>
                        <?php
                    }
                    ?>
