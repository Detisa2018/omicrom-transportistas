        ...
        <div class="sheet padding-05mm">
            ...
            <div id="exportContent" >
                <table style="width: 100%;font-family: sans-serif;" aria-hidden="true">
                    ...
                    <?php
                    $ValidaPagoReal = "SELECT valor FROM variables_corporativo  WHERE llave = 'CorreoArchivosCia'";
                    $Pr = utils\IConnection::execSql($ValidaPagoReal);
                    ?>
                    <tr><td style="text-align: justify; font-size: 18px;" >Correo electrónico: <?= $Pr["valor"] ?></td></tr>
