            ...
            <div id="tbl_exporttable_to_xls">
                ...
                <div id="Reportes" style="min-height: 200px;"> 
                    ...
                    <table id="Concentrado"  summary="Detalle del concentrado diario">
                        ...
                        <tr>
                            <th style="width:12%;" scope="col">Aceites</th>
                            <th style="width:7%;" scope="col">Ventas</th>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td class="numero"><?= number_format($registrosAceGRAL["importe"] / (1 + $registrosAceGRAL["iva"]), 2) ?></td>
                            <td class="numero"><?= number_format(($registrosAceGRAL["importe"] / (1 + $registrosAceGRAL["iva"])) * $registrosAceGRAL["iva"], 2) ?></td>
                            <td></td>
                        ...
                        <tr class="subtotal">
                            ...
                            <td></td>
                            <td class="numero"><?= number_format($ImporteTotal + ($registrosAceGRAL["importe"] / (1 + $registrosAceGRAL["iva"])), 2) ?></td>
                            <td class="numero"><?= number_format($totalIva + ($registrosAceGRAL["importe"] / (1 + $registrosAceGRAL["iva"])) * $registrosAceGRAL["iva"], 2) ?></td>
                        ...
                        <tr style="height: 40px;">
                            ...
                            <td>
                                ...
                                if ($usuarioSesion->getTeam() !== "Operador") {
                                    ...
                                    <span><div onclick="generatePDF('ConcentradoDiaCnt')" title="Imprimir reporte" class="botonImportPDF"><em class="icon fa fa-lg fa-print" aria-hidden="true"></em></div></span>
