                ...
                <td style="vertical-align: top;">
                    <div id="FormulariosBoots">
                        <div class="container no-margin">
                            ...
                            <?php
                            $SqlD = "SELECT * FROM dictamenes WHERE id_tabla=$busca AND id > 0 AND tabla = 'Dictamenes';";
                            $Dd = utils\IConnection::getRowsFromQuery($SqlD);
                            ?>
                            <div class=" col-10 row background">                                
                                    ...
                                    <table style="width: 70%;margin-left: 15%;">
                                        ...
                                        foreach ($Dd as $d) {
                                            ...
                                            <tr style="background-color: <?= $ColorHtml ?>">
                                                ...
                                                <td style="text-align: center;"><a href="dictamenese.php?Op=Delete&IdOrigen=<?= $d["id"] ?>"><i class="fa-solid fa-trash-can fa-2x"></i></a></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
                                ...
                                <div class="col-10 background no-margin">
                                    <div class="row no-padding">
                                        <div class="col-6 align-left">
                                            <?= $ExistFile = is_file("/home/omicrom/xml/Dictamen_$busca.pdf") ? "<div style='width:20%;margin-left:40%; border:1px solid black;text-align:center;border-radius:5px;background-color:#099;color:white;' id='DescargaArchivo'>Descarga</div>" : ""; ?>
                                        </div>
                                    </div>
                                    <div class="row no-padding">
                                        <div class="col-6">
                                                ...
                                                <table style="width: 70%;margin-left: 15%;" id="DownloadDictamen" title="Bajar dictamen" summary="Bajar dictamen">
                                                    <tr>
                                                        <th style="text-align: center;">
                                                            <div class="row no-padding" style="width: 400px;height: 100px;">
                                                                <div class="col-12">
                                        ...
                                        <div class="col-6">
                                            <table style="width: 70%;margin-left: 15%;" id="DownloadDictamenPDF" title="Cargar PDF" summary="Bajar dictamen">
                                                <tr>
                                                    <th style="text-align: center;">
                                                        <div class="container show-dropzone">
                                                            <div class="row no-padding" style="width: 400px;height: 100px;">
                                                                <div class="col-lg-12">
                                                                    <div class="btn-group w-100">
                                                                        <form class="dropzone" id="myDropPdf" enctype="multipart/form-data">
                                                                            <div class="fallback">
                                                                                <input type="file" name="file" id="myId" multiple>
                                                                            </div>
                                                                        </form>
        ...
        <script type="text/javascript">
                                                    $(document).ready(function () {
                                                        ...
                                                        Dropzone.options.myDrop = {
                                                            ...
                                                            dictDefaultMessage: "Dar click para subir archivo PDF",
                                                            uploadMultiple: true,
                                                            maxFileSize: 3,
                                                            acceptedFiles: ".pdf",
                                                            init: function init() {
                                                        ...
                                                        Dropzone.options.myDropCreate = {
                                                            ...
                                                            dictDefaultMessage: "Dar click para subir archivo XML",
                                                            init: function init() {
                                                        ...
                                                        Dropzone.options.myDropPdf = {
                                                            url: "uploadDictamenTanques.php?busca=<?= $busca ?>&Origen=Dictamenes",
                                                            dictDefaultMessage: "Sube tu archivo PDF (copia)",
                                                            uploadMultiple: true,
                                                            maxFileSize: 3,
                                                            acceptedFiles: ".pdf",
                                                            init: function init() {
