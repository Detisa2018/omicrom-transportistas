    ...
    <body>
                            ...
                            <form class="formsEntriesSave" method="post" action="">
                                <div class="container">
                                    ...
                                    <div class="row no-padding">
                                        ...
                                        <div class="col-7">
                                            <input type="text" class="form-control form-uuid" name="UUID" id="UUID" value="<?= $Me_tmp["uuid"] ?>" onkeyup="mayus(this);" placeholder="Ej: DFA7E8F2-DF91-408F-A328-2921AF47C94A"/>
                                        </div>
                                    </div>
                                    <div class="row no-padding">
        ...
        <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    validaTipodeCarga();
                    $("select[name=TipoCarga]").change(function () {
                        validaTipodeCarga();
                    });
                    $("#UUID").change(function () {
                        if (validaTipodeCarga()) {
                            alertTextValidation("Error el uuid debe contener parametro '0' para consignaciones", "", "Aceptar", "", false, "error");
                        }
                    });
                ...
                function validaTipodeCarga() {
                    if ($("select[name=TipoCarga]").val() === "Consignacion") {
                        $("#UUID").val("0");
                        return true;
                    }
                    return false;
