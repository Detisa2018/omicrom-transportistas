    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                $("#ShowUnidades").hide();
                var cliente = decodeEntities("<?= $SCliente ?>");
                console.log(cliente);
                ...
                $("#BuscaUnidades").click(function () {
                    ...
                    if ($("#autocomplete").val().length > 5) {
                        var txtAutocomplete = $("#autocomplete").val().split(" | ");
                        var idCli = txtAutocomplete[0];
                        jQuery.ajax({
                            type: "POST",
                            url: "getByAjax.php",
                            dataType: "json",
                            ...
                            success: function (data) {
                                $("#ShowUnidades").show();
                                $("#Codigo").append('<option value="*">Todos</option>');
                                $.each(data, function (index, valor) {
                                    $("#Codigo").append('<option value="' + index + '">' + valor + '</option>');
                                });
                            }
                        });
                    } else {
    ...
    <body>
        ...
        <div id="tbl_exporttable_to_xls">
                ...
                <table aria-hidden="true">
                    ...
                    <tbody>
                        ...
                        foreach ($registros as $rg) {
                            $style = "";
                            if ($cCod !== trim($rg["impreso"]) && ($cCli === $rg["cliente"] || $contCodigo > 1)) {
                                ?>
                                <tr class="subtotal">
                                    <td colspan="14"></td>
                            ...
                            if ($cCli !== $rg["cliente"]) {
                                ...
                                ?>
                                <tr class="subtitulo">
                                    <td colspan="100%" class="tdCliente">***<?= $rg["cliente"] . " " . $rg["nombre"] ?> ***</td>
                                </tr>
                                <?php
                                $NomGuarda = $rg["nombre"];
                            }
                            ...
                            <tr <?= $style ?>>
                                ...
                                <?php if ($rg["uuid"] !== "-----") { ?>
                                    <td align="center" style="font-weight: bold; color: lightgreen"><i class="fa fa-check-square-o" aria-hidden="true"></i></td>
                                <?php } else { ?>
            ...
            <div id="Reportes" style="width: 80%;min-height: 150px;">
                <table aria-hidden="true">
                    <thead>
                        <tr class="titulo">
                            <td colspan="9">Totales por producto</td>
                        </tr>
                        <tr>
                            <td>Producto</td>
                            <td>Consumos</td>
        ...
        <div id="Reportes" style="width: 60%;min-height: 150px;">
            <table aria-hidden="true">
                <thead>
                    <tr class="titulo">
                        <td colspan="5">Total de aditivos por cliente</td>
                    </tr>
                    <tr>
                        <td>Cliente</td>
                        <td>Nombre</td>
        ...
        <?php if ($ConcentrarVtasTarjeta == "S") { ?>
            <div id="Reportes" style="width: 50%;min-height: 150px;">
                <table aria-hidden="true">
                    <thead>
                        <tr class="titulo">
                            <td colspan="3">Total de bancos</td>
                        </tr>
                        <tr>
                            <td>Banco</td>
                            <td>Nombre</td>
                    ...
                    <tbody>
                        <tr style="height: 40px;">
                            <td align="left" colspan="4">
                                <table aria-hidden="true" style="width: 70%;">
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div id="ShowButonUnidades">
                                                <button type="button" name="Busca Unidades" id="BuscaUnidades" value="Buscar" style="font-size: 12px;font-family: sans-serif">Buscar Unidades</button>
                                            </div>
                                            <div id="ShowUnidades">
                                                Unidades
                                                <select id="Codigo" name="Codigo"></select>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <td>
                                <table style="width: 70%;margin-left: 15%;">
                                    <tr>
                                        ...
                                        <td>
                                            Si<input type="radio" name="Detallado" value="Si" <?= $Detallado === "Si" ? "checked" : "" ?>><br>
                        ...
                        <tr>
                            ...
                            <td>
                                <table aria-hidden="true">
                                    ...
                                    <tr>
                                        <td style="text-align: right;"> Dispensario</td>
                                        <td style="text-align: left;">
