        ...
        <div id="TablaDatos">
            <table aria-hidden="true"> 
                ...
                foreach ($registros as $rg) {
                    ...
                    echo "<tr>";
                    echo "<td align='center'><a class='textosCualli_i_n' href=javascript:winuni('rmvendedor.php?criteria=ini&Corte=$Corte&busca=" . $rg["despachador"] . "')><i class=\"icon fa fa-lg fa-list-alt\" aria-hidden=\"true\"></i></a></td>";
