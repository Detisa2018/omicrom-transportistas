    ...
    <body>
        ...
        <table style="width: 100%;" class="texto_tablas" aria-hidden="true">
            ...
            if ($busca === "NUEVO") {
                ...
                <tr>
                    <td colspan="100%">
                        <table style="width: 40%;margin-left: 15%;">
                            <tr>
                                <td style="padding-top: 25px;">
                                    ...
                                    if ($VcSc["valor"] == 1) {
                                        ...
                                        <div class="row background">               
                                            <div class="col-5 align-right" style="font-weight: bold;text-align: right;">Cliente :</div>
                                            <div class="col-5">
                                            ...
                                            <div class="container show-dropzone" style="padding-top: 15px;" >
                ...
                <?php
            } else if ($busca !== "NUEVO" AND $VcSc["valor"] == 1) {

                $Cliente = "SELECT CONCAT(cli.id,'.-',cli.nombre , ' | ', cli.observaciones) nombre "
                        . "FROM omicrom.rm LEFT JOIN cli ON cli.id=rm.cliente where rm.id =" . $rmVO->getId();
                ...
                <tr>
                    <td colspan="100%">
                        <form name="ReAsignacion" id="ReAsignacion">
                            ...
                            <input type='hidden' name='busca' id='buscaRa'>
                        </form>
                    </td>
                </tr>
                <?php
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#autocompleteGen").change(function () {
                    setTimeout(function () {
                        localStorage.setItem("Usr", $("#autocompleteGen").val());
                    }, 1000);
                });
                ...
                Dropzone.options.myDrop = {
                    ...
                    params: function (file, xhr, chunk) {
                        return {
                            Cliente: localStorage.getItem("Usr")
                        };
                    },
                    init: function init() {
                        this.on("addedfile", function () {
                            setTimeout(function () {
                                $(location).attr('href', 'remisiones.php?criteria=ini');
                            }, 800);
                        });
                    }
                }
                $("#autocomplete").activeComboBox($(""),
                        "SELECT id as data, CONCAT(id, ' | ', nombre, ' | ', tipodepago) value FROM cli WHERE TRUE AND tipodepago NOT IN ('Contado','Monedero') AND activo = 'Si'",
                        "nombre");
