                                ...
                                <div id="boletos">
                                    <table aria-hidden="true">
                                        <tbody>
                                            ...
                                            <tr><td style="font-size: 12px;"><strong>Bueno por $ <?= number_format($Boletos["importe"], 2) ?></strong></td></tr>            
                                ...
                                <div id="boletos" style="float: right;">
                                    <table aria-hidden="true">
                                        <tbody>
                                            ...
                                            <tr><td colspan="2"><?= $converter->convert($Boletos["importeR"], 'pesos') ?></td></tr>            
                                            <tr><td colspan="2"><?= $Dato5 ?></td></tr>            
                                            <tr>
