...
<html lang="es" xml:lang="es">
    ...
    <body>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <?php if ($row["tipo_venta"] === TipoVenta::NORMAL) { ?>
                                <a href="remisionese.php?busca=<?= $row["id"] ?>" title="Cambiar a pago con tarjeta o para un cliente"><?= $VcSc["valor"] == 1 ? "Editar" : "seleccionar"; ?></a>
                            <?php } ?>
                        </td>
                        <td style="text-align: center;">
        ...
        echo $paginador->footer(true, $nLink, false, true);
        ?> 

        <?php if ($usuarioSesion->getTeam() !== PerfilesUsuarios::FACTURACION) { ?>
