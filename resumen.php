...
$Id2 = 206;
$data2 = array("Nombre" => "Ventas realizadas en el mes" . $mes . "", "Reporte" => $Id2, "Fecha" => $Fecha,
        "mes" => $Mes, "anio" => $Anio);
                                ...
                                <div id="Reportes">
                                    <table style="width: 100%;border: 1px solid #999999;border-radius: 5px;" summary="Reportes generales Resumen">
                                        ...
                                        <tr title="Monto total vendido en pesos">
                                            ...
                                            <td style="text-align: center;"><a href="report_excel_reports.php?<?= http_build_query($data2) ?>"><i class="fa fa-list-alt fa-lg edit" aria-hidden="true"></i></a></td>
                                        </tr>
                                        <tr title="Total de venta facturada por tickets (rm)">
                                            <td>Facturado</td>
