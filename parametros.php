...
?>
                ...
                $("#UltimaVerificacion").val("<?= $Ulv["valor"] ?>");
                        ...
                        <div class="container">
                            <div class="row background">
                                ...
                                <div class="col-6">
                                    ...
                                    <form>
                                        <div class="row no-padding">
                                            <div class="col-12 align-center subtitulos">Fecha de verficación</div>
                                            <div class="col-4 align-right"></div>
                                            <div class="col-4 align-right"><input type="date" name="UltimaVerificacion" id="UltimaVerificacion"></div>
                                            <div class="col-4"><button type="submit" name="Boton" value="Actualizar Verificacion">Actualizar</button></div>
                                        </div>
                                    </form>
                                    <div class="row no-padding">
                                        <div class="col-12">
