...
class IngresosVO {
    ...
    public function getId_servicios_tra() {
        return $this->id_servicios_tra;
    }

    public function setId_servicios_tra($id_servicios_tra): void {
        $this->id_servicios_tra = $id_servicios_tra;
    }

    public function getId_prv() {
        return $this->id_prv;
    }

    public function setId_prv($id_prv): void {
        $this->id_prv = $id_prv;
    }
