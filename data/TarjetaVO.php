...
class TarjetaVO {
    ...
    public function __toString() {
        $objectClass = "{id = " . $this->id . ",descripcion = " . $this->descripcion . ",cliente = " . $this->cliente . ", placas = " . $this->placas . ", importe =  " . $this->importe . ", "
                . "periodo = " . $this->periodo . ", simultaneo = " . $this->simultaneo . ",local = " . $this->local . ",  interes = " . $this->interes . ","
