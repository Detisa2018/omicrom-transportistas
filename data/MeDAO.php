...
class MeDAO implements FunctionsDAO {

    const RESPONSE_VALID = "OK";
    const TABLA = "me";
    const MAX_VOLUMEN = 100;
    ...
    public function create($objectVO = MeVO) {
        ...
        if (($ps = $this->conn->prepare($sql))) {
            $ps->bind_param("dssssssssssssssssssssssssssssssssssss",
                    $objectVO->getUsuario(),
                    $objectVO->getTanque(),
                    $objectVO->getFecha(),
                    $objectVO->getFechae(),
    ...
    public function fillObject($rs) {
        ...
        if (is_array($rs)) {
            ...
            $objectVO->setPunto_internacion($rs["punto_internacional"]);
...
abstract class UnidadMedida extends BasicEnum {
...
abstract class Conversion extends BasicEnum {
