...
class ClientesVO {
    ...
    public function getDescuentocli() {
        return $this->descuentocli;
    }

    public function setDescuentocli($descuentocli): void {
        $this->descuentocli = $descuentocli;
    }
    ...
    public static function parse($queryParameters) {
        ...
        $cliente->setDescuentocli($queryParameters["descuentocli"]);
        //error_log($cliente);
        return $cliente;
    }
...
//parse
    ...
    public function __toString() {
        return "ClientesVO={id=" . $this->id
                ...
                . "descuentocli = " . $this->descuentocli . "}";
    }
