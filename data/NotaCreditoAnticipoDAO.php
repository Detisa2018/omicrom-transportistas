...
class NotaCreditoAnticipoDAO extends NotaCreditoDAO {
    ...
    public function conceptos() {
        ...
        $Iva = \com\softcoatl\utils\IConnection::execSql("select iva/100 iva from cia");
        $Iva = $Iva["iva"];
        ...
        $sql = "
            SELECT 
                    ...
                    , round(total/" . (1 + $Iva) . ",2) valorunitario
                    , round(total/" . (1 + $Iva) . ",2) base_iva
                    , '" . $Iva . "0000' factoriva
                    , round(total - round(total/" . (1 + $Iva) . ",2),2) tax_iva
