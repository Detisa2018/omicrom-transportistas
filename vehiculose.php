    ...
    <body>
                        ...
                        <div class="container no-margin">
                            <div class="row no-padding">
                                <div class="col-12 background no-margin">
                                    <form name="formulario1" id="formulario1" method="post" action="">
                                        ...
                                        <div class="row no-padding">
                                            <div class="col-3 align-right">Peso bruto: <sup class="sup">1</sup></div>
                                            <div class="col-1"><input type="text" name="PesoBruto" id="PesoBruto" required/></div> <div class="col-1">Kgs</div>
                                        </div>                                                                                                                                                 
                                        <div class="row no-padding">
                            ...
                            <div class="row">
                                <div class="col-12 no-margin" style="font-size: 10px; color:#55514e;">
                                    ...
                                    <div class="row no-padding">
                                        <div class="col-12">
                                            <strong class="sup">1. Peso Bruto : </strong>
                                            PesoBrutoVehicular = Peso del vehículo vacío + Capacidad máxima de carga.<br>
                                            Es un valor técnico autorizado, no un dato del viaje o del CFDI.<br>
                                            Se obtiene del permiso de la SCT o de la tarjeta de circulación federal, donde normalmente se indica como “Peso Bruto Vehicular (PBV)” o “Peso Máximo Autorizado”.
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#PesoBruto").val("<?= $objectVO->getPeso_bruto() ?>");
