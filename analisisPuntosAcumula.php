...
$Gtt = "SELECT descripcion,IF(tipo_concepto='V','Litros generan','Pesos generan') Tipo ,monto_promocion,tipo_periodo,producto_promocion,factores_producto "
        . "FROM periodo_puntos WHERE activo = 1 AND tipo_periodo = 'A';";
