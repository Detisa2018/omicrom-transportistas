    ...
    <body>
                            ...
                            <div class="row no-padding">
                                <div class="col-10 background no-margin">
                                    <form name="formulario1" id="formulario1" method="post" action="">
                                        ...
                                        <div class="row no-padding">
                                            <div class="col-4 align-right required">No. Registro Fiscal:</div>
                                            <div class="col-3"><input type="text" name="RegistroFiscal" id="RegistroFiscal" placeholder="" required=""/></div>
                                        </div>       
                                        <div class="row no-padding">
                                            <div class="col-4 align-right required">Recidencia Fiscal:</div>
                                            <div class="col-3"><?= ComboboCatalogos::generate("RecidenciaFiscal") ?></div>
                                        </div>                                                                                                                   
                                        <div class="row no-padding">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#RegistroFiscal").val("<?= $objectVO->getRegistro_fiscal() ?>");
                $("#RecidenciaFiscal").val("<?= $objectVO->getRecidencia_fiscal() ?>");
