...
$CpDAO = new \com\detisa\omicrom\CartaPorteDAO($busca, "T");
if (is_numeric($busca)) {
    $CpVO = $CpDAO->retrieve($busca, "tabla = 'Traslados' AND  id_origen");
}
        ...
        <table style="width: 100%;" class="texto_tablas" aria-hidden="true">
            <tr>
                <td style="text-align: center;" class="nombre_cliente">
                    <a href="traslados.php"><img src="libnvo/regresa.jpg" alt="Flecha regresar"></a><br/>regresar
                </td>
                <td style="vertical-align: top;">
                    ...
                    if ($TrasladosVO->getUuid() === OrigenFacturaTraslados::SINTIMBRAR) {
                        ...
                        <div style="padding-left: 70%;width: 100%;background-color: #52BE80; color: white; text-align:center; font-family: Helvetica, Arial, Verdana, Tahoma, sans-serif; font-size:14px; font-weight:bold;border-radius: 10px;">
                            <a href="TrasladosCartaPortee.php">CONFIRMACIÓN FINAL DE DATOS</a>
                        </div>
                        <?php
                    }
                    ?>
                                        ...
                                        <div class="col-12 background no-margin">
                                            ...
                                            <div class="row no-padding">
                                                ...
                                                <div class="col-4 VehiculosShow align-right" style="padding-top: 15px;">
                                                    ...
                                                    if ($TrasladosVO->getUuid() === OrigenFacturaTraslados::SINTIMBRAR) {
                                                        ?>
                                                        <input type="submit" class="styleBotonSubmit" name="Comprobante" value="<?= $ActuNvo ?>" style="margin-right: 25px;">
                                                        <?php
                                                    }
                                                    ?>
                                                </div>
                                            ...
                                            <div class="col-12 background no-margin">
                                                <div class="row no-padding">
                                                    ...
                                                    <div class="col-1 DireccionesShow" style="padding-top: 15px;">
                                                        ...
                                                        if ($TrasladosVO->getUuid() === OrigenFacturaTraslados::SINTIMBRAR) {
                                                            ?>
                                                        <input class="styleBotonSubmit" type="submit" name="Remolque" value="Agregar Remolque" id="Remolque">
                                                            <?php
                                                        }
                                                        ?>
                                                    </div>
                                ...
                                <div id="FormulariosBoots">
                                    <div class="container no-margin">
                                        <div class="row no-padding">
                                            <div class="col-12 background no-margin">
                                                <div class="row no-padding">
                                                    <div class="col-1 align-right">Producto:</div>
                                                    <div class="col-4 "><?php ComboboxInventario::generate("Producto", "'Combustible'", "") ?></div>
                                                    <div class="col-1 align-right">Cnt:</div>
                                                    <div class="col-1"><input type="text" id="Cantidad" name="Cantidad" placeholder="Cantidad" required></div>
                                                    <div class="col-3"></div>
                                                    <div class="col-1"><input type="submit" name="Boton" value="Agrega Producto" class="styleBotonSubmit"></div>
                                                </div>
                                                <div class="row no-padding">
                                        ...
                                        <div class="row no-padding">
                                            <div class="col-12 background no-margin">
                                                <div class="row no-padding">
                                                    ...
                                                    <div class="col-5 DireccionesShow" style="padding-top: 15px;">
                                                        <strong>Origen</strong>
                                                        <select name="DireccionOrigen" id="DireccionOrigen">
                                                            <?php
                                                    ...
                                                    <div class="col-5 DireccionesShow" style="padding-top: 15px;">
                                                        Fecha de llegada:<br>
                                                        <input type="datetime-local" name="HoraLlegadaOrigen" id="HoraLlegadaOrigen" style="font-family: sans-serif;font-size: 11px;color: #55514e;">
                                                    </div>
                                                    <div class="col-1 DireccionesShow" style="padding-top: 15px;">
                                                        <br>
                                                        <?php
                                                        if ($TrasladosVO->getUuid() === OrigenFacturaTraslados::SINTIMBRAR) {
                                                            ?>
                                                            <input class="styleBotonSubmit" type="submit" name="DireccionesOrigen" value="Agregar">
                                                            <?php
                                                        }
                                                        ?>
                                                    </div>
                                                    <?php
                                                    showDirecciones($CpVO->getId(), "Origen", $TrasladosVO);
                                                    ?>
                                                </div>
                                                <div class="row no-padding" style="border-top: 1px solid black;margin-top: 20px;"></div>
                                                <div class="row no-padding">
                                                    <div class="col-5 DireccionesShow" style="padding-top: 15px;">
                                                        <strong>Destino</strong>
                                                        <select name="DireccionDestino" id="DireccionDestino">
                                                            <?php
                                                            $arrayDatos = CatalogosSelectores::getDireccion("'C'");
                                                            foreach ($arrayDatos as $key => $value) {
                                                                ?>
                                                                <option value="<?= $key ?>"/><?= $value ?></option>
                                                                <?php
                                                    ...
                                                    <div class="col-2 DireccionesShow" style="padding-top: 15px;">Distancia :
                                                        <input type="text" name="DistanciaDestino" id="DistanciaDestino" placeholder="Km"> 
                                                    </div>
                                                    <div class="col-3 DireccionesShow" style="padding-top: 15px;">
                                                        Fecha de llegada:<br>
                                                        <input type="datetime-local" name="HoraLlegadaDestino" id="HoraLlegadaDestino" style="font-family: sans-serif;font-size: 11px;color: #55514e;">
                                                    </div>
                                                    <div class="col-1 DireccionesShow" style="padding-top: 15px;">
                                                        <?php
                                                        if ($TrasladosVO->getUuid() === OrigenFacturaTraslados::SINTIMBRAR) {
                                                            ?>
                                                            <input class="styleBotonSubmit" type="submit" name="DireccionesDestino" value="Agregar">
                                                            <?php
                                                        }
                                                        ?>
                                                    </div>
                                                    <?php
                                                    showDirecciones($CpVO->getId(), "Destino", $TrasladosVO);
                                                    ?>
                                                </div>
                                            </div>
                                        </div>
...
function showDirecciones($IdNvo, $Direccion, $TrasladosVO) {
    $sql = "SELECT cpd.tipo,cpds.estado,cpc.nombre,cpds.calle,cpds.codigo_postal,cpl.descripcion,
                                                ...
                                                WHERE cp.id=" . $IdNvo . " AND cpd.tipo = '$Direccion' AND cpd.origen='TRA' AND cpc.codigo_postal = cpds.codigo_postal  
                                                GROUP BY cpd.id ORDER BY cpd.tipo;";
    $Direc = utils\IConnection::getRowsFromQuery($sql);
    foreach ($Direc as $co) {
        ?>
        <div class="ExisteDirecciones" style="background:#FFF;border-radius: 5px;border:1px solid #AFB0B2;padding: 5px;margin: 5px;width: 900px;" class="col-5 DireccionesShow">
            <div style="width: 95%;padding-left: 75%;">
            </div>
            <table style="width: 100%;">
                ...
                <tr>
                    <td><strong>Estado :</strong> <?= $co["estado"] ?></td>
                    <td colspan="2"><strong>Colonia :</strong> <?= $co["nombre"] ?></td>
                </tr>
                <tr>
                    <td colspan="3"><strong>Calle :</strong> <?= $co["calle"] ?></td>
                </tr>
                <tr>
                    <td><strong>Codigo Postal :</strong> <?= $co["codigo_postal"] ?></td>
                    <td><strong>No. Int. </strong><?= $co["num_interior"] ?></td>
                    <td><strong>No. Ext. </strong><?= $co["num_exterior"] ?></td>
                </tr>
                <tr>
                    <td colspan="3"><strong>Referencia :</strong> <?= $co["descripcion"] ?></td>
                </tr>
                <tr>
                    <td colspan="2"><strong>Fecha de Llegada :</strong> <?= $co["fecha"] ?></td>
                    <td><strong>Fecha de Llegada :</strong> <?= $co["fecha"] ?></td>
                </tr>
            </table>
        </div>
        <?php
