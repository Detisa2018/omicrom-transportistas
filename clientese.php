    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $("#PermisoCRE").val("<?= $clienteVO->getObservaciones() ?>");
                ...
                $("#DescuentoCliente").val("<?= $clienteVO->getDescuentocli() ?>");
    ...
    <body>
                                ...
                                <div class="row no-padding">
                                    <div class="col-12 background container no-margin">
                                        <form name="formulario2" id="formulario2" method="post" action="">
                                            ...
                                            <?php
                                            if ($clienteVO->getTipodepago() === "Monedero") {
                                                ?>
                                                <div class="row no-padding">
                                                    <div class="col-3 align-right">RFC del monedero: </div>
                                                    <div class="col-5">
                                                        <input type="text" name="RFCMonedero" id="RFCMonedero" maxlength="40" value="<?= $clienteVO->getObservaciones() ?>"/>
                                                    </div>
                                                </div>
                                                <?php
                                            }
                                            ...
                                            if ($VcSc["valor"] == 1) {
                                                ?>
                                                <div class="row no-padding">
                                                    <div class="col-3 align-right">Permiso CRE: </div>
                                                    <div class="col-5">
                                                        <input type="text" name="PermisoCRE" id="PermisoCRE" maxlength="40" class="clase-<?= $clase2 ?>"/>
                                                    </div>
                                                </div>
                                                <?php
                                            }
                                            ...
                                            if ($usuarioSesion->getTeam() !== PerfilesUsuarios::FACTURACION) {
                                                ...
                                                if ($Vvl["valor"] == 1 && ($clienteVO->getTipodepago() === "Credito" || $clienteVO->getTipodepago() === "Prepago" || $clienteVO->getTipodepago() === "Contado")) {
                                                    ?>
                                                    <div class="row no-padding">
                                                        <div class="col-3 align-right">% de descuento </div>
                                                        <div class="col-1"> <input type="text" name="DescuentoCliente" id="DescuentoCliente"></div>
                                                        <div class="col-6 mensajeInput" > Todos los consumos relacionados seran afectados por un desucuento que se indique (MAX 20%)</div>
                                                    </div>
                                                    <?php
                                                }
                                                ?>
                                    ...
                                    $(document).ready(function () {
                                        ...
                                        $(".fa-pencil").click(function () {
                                            ...
                                            jQuery.ajax({
                                                ...
                                                dataType: 'json',
                                                cache: false,
                                                data: {"Op": "ObtenDireccion", "idDireccion": idDireccion, "Origen": "C"},
                                                success: function (data) {
                                                    console.log(data);
                                ...
                                <div class="container no-margin" style="margin-top: 15px;">
                                    <div class="row no-padding">
                                        <div class="col-12 background container no-margin">
                                            ...
                                            <div style="width: 100%; text-align: center;"><h3>DIRECCIONES ASOCIADAS AL CLIENTE</h3></div>
                                            ...
                                            <table style="width: 80%;margin-left: 10%;background-color: white;border-radius: 10px;padding: 10px;">
                                                ...
                                                <?php
                                                $SqlDetalle = "SELECT * FROM catalogo_direcciones WHERE tabla_origen = 'C' AND id_origen = $busca AND id > 0";
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#DescuentoCliente').on('input', function () {
                    var value = $(this).val();
