...
class IConnection {
    ...
    public static function getConnectionRepository() {
        ...
        $dbConn = new \mysqli($dbc->host, $dbc->username, $dbc->pass, $dbc->database, 2409);
    ...
    public static function getConnectionRepositoryGlobalFae() {

        $dbc = Configuration::getRepositoryGlobalFae();
    ...
    public static function execSqlGlobalFae($sql) {
        $object = array();
        $mysqli = self::getConnectionRepositoryGlobalFae();
        try {
    ...
    public static function execSqlCorp($sql) {
        $object = array();
        $mysqli = self::getConnectionRepository();
        try {
            if (($query = $mysqli->query($sql)) && ($rs = $query->fetch_assoc())) {
                $object = $rs;
            }
