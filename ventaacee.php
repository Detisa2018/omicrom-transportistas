        ...
        <script>
            $(document).ready(function () {
                ...
                $("#Posicion").change(function () {
                    Swal.fire({
                        title: '¿Seguro de modificar el inventario de la isla?',
                        ...
                        jQuery.ajax({
                            ...
                            dataType: "json",
                            cache: false,
                            data: {"Op": "ModificaVentaAditivoIsla",
                                "Producto": "<?= $objectVO->getProducto() ?>",
                                "IslaOrigen": "<?= $objectVO->getPosicion() ?>",
                                "IslaDestino": $("#Posicion").val(),
                                "Cantidad": "<?= $objectVO->getCantidad() ?>",
                                "IdVt": "<?= $busca ?>",
                                "Usr": "<?= $usuarioSesion->getUsername() ?>"},
                            beforeSend: function () {
                                getCargando();
                            },
                        ...
                        <div id="FormulariosBoots">
                            <div class="container no-margin">
                                ...
                                <div class="row no-padding">
                                    ...
                                    <div class="col-4"><?= ListasCatalogo::getPosiciones("Posicion", "", ""); ?></div>
                                </div>
                                <div class="row no-padding">
