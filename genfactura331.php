    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                ...
                regresaFormaPago("<?= $fcVO->getMetododepago() ?>", "<?= $fcVO->getFormadepago() ?>");
                    ...
                    <form name="form1" id="form1" method="post" action="">
                        <table style="width: 100%;" class="texto_tablas" aria-hidden="true">
                            ...
                            <?php if ($usuarioSesion->getLevel() >= 7) { ?>
                                <?php if ($clienteVO->getRfc() !== "XAXX010101000") { ?>
                                    <tr>
                                ...
                                <tr id="ViewGenerico">
                                    <td></td>
                                    <td>
                                        Año: <input style="width: 60px;margin-left: 5px;" type="text" name="Anio" value="<?= $fcVO->getAno() ?>" class="texto_tablas">
